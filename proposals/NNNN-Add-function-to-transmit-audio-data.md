...
Due to the current implementation, it is not possible to cancel the playback of data ,which has been sent to theHU, hence audio interruption function can not be implemented.
