 ...
 */
@property (copy, nonatomic, readonly) NSArray<SDLTTSChunk *> *prompt;

/**
 If created with an audio file, the audio file that will be uploaded and used.
 */
@property (copy, nonatomic, readonly) SDLFile *audioFile;
 ...
 */
@property (strong, nonatomic) SDLAlertAudioData *audio;
...
*/
@property (strong, nonatomic) SDLArtwork *icon;
