 ...
 */
@property (nullable, copy, nonatomic, readonly) SDLAlertAudioData *audio;
 ...
 */
@property (assign, nonatomic, readonly) BOOL showWaitIndicator;
...
*/
@property (nullable, copy, nonatomic, readonly) SDLArtwork *icon;
...
public class AlertView {
    ...
    // All vars have get as well to match iOS code writability
